...
public class SUDOKU {
	...
	static boolean[][][] possibility = new boolean[9][9][10];
	static int globalMsg1 = 0;
	...
	public static void main(String[] args) {
		...
		if (ifSolved(input) == false) {
			System.out.println("\n\n-This is a hard one TAT");
			typing(250,2,3,"typing");
			System.out.println("-Geeez, now I have to enumerate :(");
			typing(250,2,3,"typing");
			System.out.println("-Ughhhh!!");
			typing(250,2,3,"typing");
			System.out.println("-Please don't torture me OK? :<");
			typing(250,2,3,"typing");
			System.out.println("-Computers should be loved, you know?");
			typing(320,3,3,"working");
			int hypoNum = 0;
			while (globalMsg1 == 0) {
				hypoNum++;
				...
				// showCurrentInput(hypothesis);
				// System.out.println(hypoNum);
				// System.out.println(globalMsg1);
				solve(hypothesis);
				// showCurrentInput(hypothesis);
				if (ifSolved(hypothesis) == true) {
					System.out
							.println("\n----------\n-phewwww finally! Here you go:");
					waitTime(800);
					for (int i = 0; i < 9; i++) {
		...
		}else System.out.println("-It's not a hard one.");
		System.out.print("\n");
	...
	private static void typing(long gap, int loops, int dots, String text) {
	...
	private static boolean isNNum(String testee) { // N stands for natural
	...
	private static void showCurrentInput(int[][] obj) {
		for (int i = 0; i < 9; i++) { // for testing purposes
			for (int u = 0; u < 9; u++) {
				/*
				 * for(int v=0 ; v< 10 ; v++){
